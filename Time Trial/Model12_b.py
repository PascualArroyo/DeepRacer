def reward_function(params):
    ...
    ABS_STEERING_THRESHOLD_1 = 5
    ABS_STEERING_THRESHOLD_2 = 10
    ABS_STEERING_THRESHOLD_3 = 20
    
    

    if abs(track_direction-track_direction2) < 5:
        # Penalize reward if the agent is steering too much
        if steering > ABS_STEERING_THRESHOLD_3:
            reward_sterring = 0
        elif steering > ABS_STEERING_THRESHOLD_2:
            reward_sterring = 0.2
